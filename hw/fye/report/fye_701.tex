...
\begin{figure}[H]
  ...
  univariate histograms for each of the variables. Lower traingle: correlations
...
\begin{figure}[H]
  ...
  traingle: correlations between each pairs of covariates. Upper triangle:
...
\begin{figure}[H]
  ...
  Lower traingle: correlations. Upper triangle: bivariate distributions. Navy blue regions
...
\begin{figure}[H]
  ...
  \caption{\small Heatmap of ozone varying in both wind speed and temperature. 
    ...
    middle and botton panels display the ozone levels for $\M_2$. The middle
